...
jhu_root = '/scratch/jianyong/jhu_crowd_v2.0'
qnrf_root = '/scratch/jianyong/UCF-QNRF_ECCV18'
ucf50_root = '/scratch/FIDTM/UCF50/folder5'
...
try:
    ucf50_train_path = ucf50_root + '/train_data/images/'
    ucf50_test_path = ucf50_root + '/test_data/images/'
    ...
    train_list.sort()
    np.save('./npydata/ucf50_train5.npy', train_list)
    ...
    test_list.sort()
    np.save('./npydata/ucf50_test5.npy', test_list)
    print("Generate ucf50 image list successfully")
except:
    print("The ucf50 dataset path is wrong. Please check your path.")